...
/* ============================================================
   ...
   ============================================================ */
const LOGROS=[
 {id:"arquero_penal", n:"Bomba de hidrógeno vs bomba de hidrógeno", d:"Hacé patear un penal a tu arquero y que lo meta. Si lo marca, te llevás el oro."},
 {id:"clasico_casa",  n:"El pueblo unido",          d:"Ganá un clásico con 3 o más jugadores de la casa en el once."},
 {id:"remontada",     n:"Nunca bajar los brazos",   d:"Ganá un partido después de ir perdiendo por dos goles."},
 {id:"gol_defensa",   n:"El defensor que soñó con ser 9", d:"Que un defensor te haga un gol de cabeza."},
 {id:"roja_gana",     n:"Con uno menos y con el alma", d:"Ganá un partido después de quedar con diez por una roja."},
