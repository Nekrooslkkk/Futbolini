...
var FRASES={
  ...
  neutro:{
    ...
    mep_solo:"En esta época solo se sigue el torneo local: el resto del continente no está modelado para este año.",
  ...
  pt:{
    ...
    mep_solo:"Nesta época só se acompanha o torneio local: o resto do continente não está modelado para este ano.",
  ...
  en:{
    ...
    mep_solo:"In this era only the local league is followed: the rest of the continent isn't modelled for this year.",
