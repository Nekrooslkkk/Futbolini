# Futbolini — listado de mejora (beta de experiencia)

Orden: lo que hace que no se abandone, primero. Lo de vida/IA, después.
...
2. 🟨 Corte 18/08 con resultados del club + tabla semilla. La tabla de los otros no es acta.
3. ✅ Simular el resto de la liga cada fecha (5.1k).
...
28. 🟨 Chirp 2008: inicio / menciones / tendencias, like RT reply, hilo.
29. ⬜ Cuentas persistentes (el mismo @hincha_de_ley vuelve y se acuerda).
30. ⬜ Hilos de 4–6 posts, no un tweet suelto.
31. 🟨 Periodistas con línea persistente (5.1k).
32. ⬜ Jugadores que postean según moral, no al azar.
33. ⬜ Rival que se mete la semana del clásico.
34. ⬜ Hashtag que nace de un hecho (gol anulado, remate, estatuto).
35. ⬜ Notificaciones: te mencionaron, te citaron, tendencia en contra.
36. ⬜ DMs (hincha pesado, periodista, dirigente).
37. ⬜ Borrar/editar no existe: lo publicado queda.
38. ⬜ Seguir / dejar de seguir cuentas (cambia el feed).
39. ✅ Límite 140 caracteres en el compose (5.1l).
40. ⬜ Viralidad: un RT tuyo de un hincha bravo te explota.
...
- Elegís CC / UCH / UC 1991 o 2026.
- El calendario no miente.
- Avanzar no salta partidos.
- Un año se siente distinto de otro.
- La plata te puede echar.
- Chirp habla solo cuando pasa algo.
- Guardar y seguir mañana.

Cuando eso esté, recién Tinder, dinastía y servidor con modelo.
