...
## 7.49 · Segunda División Profesional (3er nivel) jugable
- **data-segunda2026.js (nuevo)**: 14 clubes REALES de la Segunda División Profesional 2026 (Santiago Morning, Lota Schwager, Osorno, Linares, Colchagua, Trasandino, Atlético Colina, Ovalle, Concón National, Brujas de Salamanca, Real San Joaquín, Santiago City, General Velásquez, Rengo) con ciudad, estadio y zona Norte/Sur reales (Wikipedia/ANFP). DTs sin inventar (cuerpo técnico); planteles cantera. Registra LIGAS["2026c"], CLUB_INFO/IND/CAJA/estatuto/poder.
- **motor.js/data-liga.js/ui.js/index.html**: datosEra + nuevaPartida reconocen base "2026c"; clubMapaTodos incluye la C; selector con sección "Segunda División 2026" + elegirEpoca; ligaN/textos. Elegible y jugable como liga (round-robin). Formato real grupos+liguilla y ascenso a B: siguiente parche.
**Probado:** node --check + boot headless (Santiago Morning jugable, 26 partidos simulados, navegación 6 vistas, 0 errores de consola).
...
## 7.77-tools2 · Fotos: rechazo de links de búsqueda/página (anti-basura)
